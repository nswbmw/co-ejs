...
var parse = exports.parse = function(str, options, isInclude){
  var options = options || {}
  ...
  for (var i = 0, len = str.length; i < len; ++i) {
    ...
    if (str.slice(i, open.length + i) == open) {
      ...
      if (0 == js.trim().indexOf('include')) {
        ...
        include = exports.parse(include, { filename: path, _with: false, open: open, close: close}, true);
        buf += "'); " + include + "', '";
        js = '';
      }
...
exports.renderFile = function*(path, options, fn){
  ...
  fn(null, yield *exports.render(str, options));
};
